...
openai_api_key = "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"
...
def record():
    ...
    with sd.InputStream(callback=audio_callback, channels=1, dtype='int16', samplerate=sample_rate):
        ...
        silence_duration =1  # Adjust silence duration for automatic stopping
...
def record_tamil():
    ...
    try:
        ...
        translated = GoogleTranslator(source='auto', target='en').translate(text) # type: ignore
